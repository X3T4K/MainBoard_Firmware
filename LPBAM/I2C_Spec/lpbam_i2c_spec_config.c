...
/**
  **********************************************************************************************************************
  * @file   lpbam_i2c_spec_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM I2C_Spec application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  I2C_Spec application initialization
  * @param  None
  * @retval None
  */
void MX_I2C_Spec_Init(void)
{
  /* USER CODE BEGIN I2C_Spec_Init 0 */

  /* USER CODE END I2C_Spec_Init 0 */
  ...
  /* USER CODE BEGIN I2C_Spec_Init 1 */

  /* USER CODE END I2C_Spec_Init 1 */
}
